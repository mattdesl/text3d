...
var Text3D = new Class({
	...
	initialize: function(text, face, size, steps, simplify, align, spaceWidth, letterSpacing, steinerPoints) {
	...
	setText: function(text, steps, simplify) {
        ...
        for (var i=0; i<text.length; i++) {
            ...
            var glyph = new Glyph(face, c, size, steps, simplify, 1, this.steinerPoints);
