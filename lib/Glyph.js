...
var Glyph = new Class({
    ...
    initialize: function(face, chr, size, steps, simplify, scale, steinerPoints) {
        if (!chr)
        ...
        this.triangulate(this.shapes, steinerPoints);
     ...
     */
    triangulate: function(shapes, steinerPoints) {
        this.shapes = shapes || this.shapes;

        this.points.length = 0;
        
        //Triangulate the shape data
        var triangles = triangulateShapes(this.shapes, steinerPoints) || [];
